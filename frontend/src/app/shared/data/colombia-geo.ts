// Fuente: DIVIPOLA — DANE Colombia. Todos los departamentos y municipios de Colombia.
...
export const COLOMBIA_DEPTOS: ColombiaDepto[] = [
  {
    value: 'AMAZONAS',
    label: 'Amazonas',
  ...
  },
  {
    ...
    ciudades: [
      ...
      'Copacabana', 'Dabeiba', 'Don Matías', 'Ebéjico', 'El Bagre', 'El Carmen de Viboral',
      ...
      'Mutatá', 'Nariño', 'Nechí', 'Necoclí', 'Olaya', 'Peque', 'Puerto Berrío', 'Puerto Nare',
      ...
      'Santa Rosa de Osos', 'Santo Domingo', 'Segovia', 'Sonsón', 'Sopetrán', 'Támesis',
  ...
  },
  {
    ...
    ciudades: [
      ...
      'María la Baja', 'Montecristo', 'Mompox', 'Morales', 'Norosí', 'Pinillos',
  ...
  },
  {
    ...
    ciudades: [
      ...
      'Paya', 'Paz de Río', 'Pesca', 'Pisba', 'Puerto Boyacá', 'Quípama', 'Ramiriquí',
      ...
      'Sativasur', 'Siachoque', 'Soatá', 'Socotá', 'Socha', 'Sogamoso', 'Somondoco',
      'Sora', 'Sotaquirá', 'Soracá', 'Susacón', 'Sutamarchán', 'Sutatenza', 'Tasco',
      'Tenza', 'Tibaná', 'Tibasosa', 'Tinjacá', 'Tipacoque', 'Toca', 'Togüí', 'Tópaga',
      'Tota', 'Turmequé', 'Tununguá', 'Úmbita', 'Ventaquemada', 'Viracachá', 'Zetaquira',
    ],
  },
  {
    value: 'CALDAS',
  ...
  },
  {
    ...
    ciudades: [
      ...
      'Caldono', 'Caloto', 'Coconuco', 'Corinto', 'El Tambo', 'Florencia', 'Guachené',
      'Guapi', 'Inzá', 'Jambaló', 'La Sierra', 'La Vega', 'López de Micay', 'Mercaderes',
      'Miranda', 'Morales', 'Padilla', 'Páez', 'Patía', 'Piamonte', 'Piendamó',
      'Puerto Tejada', 'Puracé', 'Rosas', 'San Sebastián', 'Santander de Quilichao',
      'Santa Rosa', 'Silvia', 'Sotara', 'Suárez', 'Sucre', 'Timbío', 'Timbiquí',
  ...
  },
  {
    ...
    ciudades: [
      ...
      'Pailitas', 'Pelaya', 'Pueblo Bello', 'Río de Oro', 'La Jagua del Pilar',
  ...
  },
  {
    ...
    ciudades: [
      ...
      'Bojayá', 'Carmen del Darién', 'Cértegui', 'Condoto', 'El Carmen de Atrato',
      ...
      'San José del Palmar', 'Sipí', 'Tadó', 'Unión Panamericana',
    ],
  },
  {
    value: 'CORDOBA',
  ...
  },
  {
    ...
    label: 'Cundinamarca',
    ciudades: [
      'Soacha', 'Agua de Dios', 'Albán', 'Anapoima', 'Anolaima', 'Apulo', 'Arbeláez',
      ...
      'Lenguazaque', 'Macheta', 'Madrid', 'Manta', 'Medina', 'Mosquera', 'Nariño',
      'Nemocón', 'Nilo', 'Nimaima', 'Nocaima', 'Ospina Pérez', 'Pacho', 'Paime',
      ...
      'Sibaté', 'Silvania', 'Simijaca', 'Sopó', 'Subachoque', 'Suesca', 'Supatá',
      'Susa', 'Sutatausa', 'Tabio', 'Tausa', 'Tena', 'Tenjo', 'Tibacuy', 'Tibirita',
      'Tocaima', 'Tocancipá', 'Topaipí', 'Ubalá', 'Ubaque', 'Une', 'Útica', 'Venecia',
      'Vergara', 'Vianí', 'Villa Gómez', 'Villagómez', 'Villapinzón', 'Villeta',
  ...
  },
  {
    ...
    ciudades: [
      ...
      'Iquira', 'Isnos', 'La Argentina', 'La Plata', 'Nátaga', 'Oporapa', 'Paicol',
  ...
  },
  {
    ...
    label: 'La Guajira',
    ciudades: [
      'Riohacha', 'Albania', 'Barrancas', 'Dibula', 'Distracción', 'El Molino',
      'Fonseca', 'Hatonuevo', 'La Jagua del Pilar', 'Maicao', 'Manaure', 'Uribia',
      'Urumita', 'Villanueva', 'San Juan del Cesar',
    ],
  },
  {
    value: 'MAGDALENA',
  ...
  },
  {
    ...
    ciudades: [
      ...
      'San Pedro de Cartago', 'Sandoná', 'Santa Bárbara', 'Santacruz', 'Sapuyes',
