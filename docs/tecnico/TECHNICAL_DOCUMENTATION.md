...
│   │   └── dashboard-bi-ventas.md      # Diseño BI dashboard de ventas
│   ├── operaciones/
│   │   └── DEPLOY.md                   # Guía de despliegue
│   ├── sprints/                        # Actas de sprint
│   ├── propuestas/                     # Propuestas comerciales
│   ├── contratos/                      # Contratos
│   ├── formatos/                       # Plantillas operativas
...
> El documento de referencia detallado está en `docs/operaciones/DEPLOY.md`.
